...
Simulates realistic parent–daycare conversations

Provides details about daycare hours, enrollment, tours, and food/snack policies

Streamed responses from LLaMA 3.2 model for a natural conversational feel

Easy to exit with the exit command

# Technologies & Tools

Python | Ollama API | LLaMA 3.2 model
